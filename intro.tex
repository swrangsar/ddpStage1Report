...
The rest of this document is organized as follows. Chapter 2 describes briefly the GSM architecture and its Um interface. Chapter 3 gives a literature survey on Universal Software Radio Peripheral (USRP N210). Chapter 4 and 5 describe the literature survey done on the GNU Radio software package and OpenBTS software respectively. Chapter 6 covers partial implementation of cognitive radio using GNU Radio and OpenBTS. It also describes proposed future work along with a flowgraph describing the algorithm for the complete implementation of cognitive radio on OpenBTS platform.
